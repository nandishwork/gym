...
export default function JoinNow() {
  ...
  const plans = [
    { name: 'Basic', price: '$49/mo' },
    { name: 'Pro', price: '$89/mo' },
    { name: 'Elite', price: '$149/mo' }
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0a] pt-24 pb-12 flex flex-col">
      <div className="max-w-4xl mx-auto px-4 w-full flex-1 flex flex-col">
        ...
        <motion.div 
          ...
          className="bg-[#111111] border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden"
        >
          {/* Subtle background glow */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-red-600/10 rounded-full blur-[80px] pointer-events-none" />
          
          <div className="relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tighter uppercase mb-2">Join <span className="text-red-600">The Elite</span></h1>
            <p className="text-[#a1a1a1] mb-10">Complete your registration to start your fitness journey today.</p>
            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="pt-4 border-t border-white/5">
                <button 
                  type="submit" 
                  className="w-full bg-red-600 text-white rounded-xl py-4 font-bold uppercase tracking-widest text-sm hover:bg-red-700 transition-colors shadow-[0_0_30px_rgba(220,38,38,0.2)]"
                >
                  Proceed to Payment
                </button>
