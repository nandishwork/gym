...
const testimonials = [
  {
    ...
    content: 'The equipment here is unmatched. It’s the only place I trust for my heavy lifting days. The environment just makes you want to work harder.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Between the recovery lounge and the expert coaches, I’ve shaved 15 minutes off my personal record. Simply incredible.',
    rating: 5,
    ...
    <section className="py-24 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter uppercase mb-4">Member <span className="text-red-600">Stories</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-[#111111] p-8 rounded-2xl border border-white/5 hover:border-white/10 transition-colors duration-300"
            >
              ...
              <p className="text-[#a1a1a1] mb-8 leading-relaxed italic">"{t.content}"</p>
