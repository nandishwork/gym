    ...
    <section className="py-16 md:py-24 lg:py-32 relative bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 md:mb-16 lg:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter uppercase mb-3 sm:mb-4">
            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#555555]">Experience</span>
          </h2>
          <p className="text-[#a1a1a1] max-w-xl text-base sm:text-lg md:text-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 min-h-[600px] md:min-h-[700px]">
          ...
          <motion.div 
            ...
            className="md:col-span-8 relative rounded-2xl overflow-hidden border border-white/5 group h-[300px] sm:h-[400px] md:h-full"
          >
            ...
            <div className="absolute bottom-0 left-0 p-6 sm:p-8 md:p-10 z-10 w-full">
              <h3 className="text-2xl sm:text-3xl font-bold uppercase tracking-tight">Rogue Equipped Zone</h3>
            </div>
          </motion.div>
          ...
          <div className="md:col-span-4 flex flex-col gap-6 h-auto md:h-full">
             ...
             >
               ...
               <div className="absolute bottom-0 left-0 p-6 sm:p-8 z-10 w-full">
                 <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-tight">Hiit Studio</h3>
               </div>
             </motion.div>
             ...
             >
               ...
               <div className="absolute bottom-0 left-0 p-6 sm:p-8 z-10 w-full">
                 <h3 className="text-xl sm:text-2xl font-bold uppercase tracking-tight">Recovery Lounge</h3>
               </div>
             </motion.div>
          </div>
