      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter leading-[1.1] uppercase">
              Build Your <br />
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
              <Link to="/join" className="bg-white text-black px-8 py-4 rounded-full font-bold uppercase tracking-wider text-sm hover:scale-105 active:scale-95 hover:bg-gray-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.15)] flex items-center justify-center space-x-2 group">
                <span>Start Journey</span>
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <button className="bg-transparent border border-white/20 text-white px-8 py-4 rounded-full font-bold uppercase tracking-wider text-sm hover:scale-105 active:scale-95 hover:bg-white/10 hover:border-white/40 transition-all flex items-center justify-center space-x-2">
          ...
          <motion.div 
            ...
            className="relative h-[400px] lg:h-[550px] w-full xl:w-[90%] ml-auto rounded-3xl overflow-hidden border border-white/10 bg-[#111111] shadow-[0_0_50px_rgba(0,0,0,0.4)]"
          >
            <img 
            ...
            <div className="absolute bottom-8 right-8 bg-[#0a0a0a]/60 backdrop-blur-md border border-white/10 p-4 rounded-xl flex items-center space-x-4">
               ...
               <div>
                 <p className="text-xs text-[#a1a1a1] uppercase tracking-wider">Voted</p>
                 <p className="font-bold text-sm">Best Premium Gym</p>
               </div>
            </div>
          </motion.div>
